...
tryCatch({
  ...
  source("3_Script/1_Code/01_Loading/poslaju/fn_LoadRateCards.R")
  source("3_Script/1_Code/01_Loading/poslaju/fn_LoadLocationMap.R")
  source("3_Script/1_Code/01_Loading/poslaju/LoadStateMap.R")
  source("3_Script/1_Code/01_Loading/poslaju/LoadCommonVariables.R")
  ...
  source("3_Script/1_Code/03_Cleanup/poslaju/CheckRateCard.R")

  source("3_Script/1_Code/05_Reports/SummaryReport.R")
  source("3_Script/1_Code/05_Reports/OutputRawData.R")
  
  variableFilePath <- "1_Input/03_poslaju/commonVariables.csv"
  omsDataFolder <- "1_Input/00_OMS_DATA"
  invoiceDataFolder <- "1_Input/03_poslaju/new_invoices"
  oldInvoiceDataFolder <- "1_Input/03_poslaju/old_invoices"
  rateCardFile <- "1_Input/03_poslaju/rate_cards/poslaju_ratecards.csv"
  locationMappingFile <- "1_Input/03_poslaju/rate_cards/locationMapping.csv"
  stateMappingFile <- "1_Input/03_poslaju/rate_cards/stateMapping.csv"
  ...
  OutputRawData(finalOutput, paste0("2_Output/poslaju/checkedInvoice_",dateReport,".csv"))
  OutputRawData(exceedThresholdTrackingNumber, paste0("2_Output/poslaju/exceedThresholdTrackingNumber_",dateReport,".csv"))
  OutputRawData(notFoundTrackingNumber, paste0("2_Output/poslaju/notFoundTrackingNumber_",dateReport,".csv"))
  SummaryReport(finalOutput, paste0("2_Output/poslaju/summaryReport_",dateReport,".csv"))
